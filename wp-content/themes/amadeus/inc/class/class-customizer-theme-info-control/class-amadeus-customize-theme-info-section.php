 ...
 */
class Amadeus_Customizer_Theme_Info_Section extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'amadeus-theme-info-section';
	...
	/**
	 * Amadeus_Customizer_Theme_Info_Section constructor.
	 */
